    ...
    if (matches.length == 0) {
        ...
        $.each(displayedmatches, function (key5, val5) {
            $.each(val5.invItems, function (key6, val6) {
                ...
                var $appendrow = $("<div class='col l3 m3 s6'><div class='card'><div class='card-image'><img src='img/" + itemid + "-" + itemid2 + ".png' class='card-image-size'><span class='card-title black-text right-align'>" + itemname + "</span></div><div class='card-content'><p><strong>Owner:</strong></p><img src='https://minotar.net/avatar/" + val5.ownerName + "/20' class='left'> <p>" + val5.ownerName + "</p><p><strong>Enchantments:</strong></p><p>" + displayedenchant + "</p><p><strong>Location:</strong></p><p><i>" + val5.locWorld + "</i> @ <a href='" + dynmapURL + "/?worldname=" + val5.locWorld + "&mapname=surface&zoom=20&x=" + val5.locX + "&y=" + val5.locY + "&z=" + val5.locZ + "' target='_blank'>" + val5.locX + ", " + val5.locY + ", " + val5.locZ + "</a></p><p><strong>In Stock?: </strong><span class='" + textColor + "'>" + $invinstock + "</span></p></div><div class='card-action'><strong>" + val5.signType + "</strong> " + val6.amount + " for <strong>$" + val5.signPrice + "</strong></div></div></div>");
